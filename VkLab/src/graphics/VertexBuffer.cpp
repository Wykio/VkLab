...
void VertexBuffer::initialize(Device* pdevice, VkQueue queue, CommandPools* commandPools) {
    ...
    copyBuffer(pdevice, queue, commandPools, stagingBuffer, vertexBuffer, bufferSize);
